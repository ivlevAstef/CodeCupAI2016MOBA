...
namespace AICup
{
  ...
  public:
    //копи€ дерева но слегка с увеличенным радиусом, дл€ того чтобы наверн€ка
  ...
  public:
    //копи€ строени€ но слегка с увеличенным радиусом, дл€ того чтобы наверн€ка
    Building(const model::Building& building, double radius);

    //копи€ строени€ но c уменьшенным временем удара
